...
export function toGraphQLApplicationProfile(profile: BackendApplicationProfile) {
  return {
    ...
    mostRecentCompany: profile.most_recent_company,
    currentTitle: profile.current_title,
    targetWorkCity: profile.target_work_city,
    targetWorkState: profile.target_work_state,
    targetWorkCountry: profile.target_work_country,

...
class ApplicationProfileType(graphene.ObjectType):
    ...
    current_company = graphene.String()
    most_recent_company = graphene.String()
    current_title = graphene.String()
    target_work_city = graphene.String()
    target_work_state = graphene.String()
    target_work_country = graphene.String()
